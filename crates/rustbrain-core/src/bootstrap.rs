...
Types: `goal`, `adr`, `alternative`, `concept`, `reference`, `edge_case`. Link code in the body with `symbol:Type::method`.
...
| `docs/goals/`, `docs/adr/`, … | Hand-written project knowledge |
